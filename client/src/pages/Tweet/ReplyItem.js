                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <span
                                className="ml-1"
                                style={{ color: "#8899A6", fontSize: "0.9rem" }}
                            >
                                @{username} ·{" "}
                            </span>
                            <span
                                style={{ color: "#8899a6", fontSize: "0.8rem" }}
                            >
                ...
                <div>
                    <p>
                        {!auth.loading && user === auth.user._id && (
                            <button
                                type="submit"
                                onClick={(e) => deleteReply(tweetId, _id)}
                                className="backarrow btn btn-sm mx-1"
                                style={{ color: "#d9534f" }}
                            >
                                <svg
                                    viewBox="0 0 24 24"
                                    class="r-daml9f r-4qtqp9 r-yyyyoo r-1q142lx r-1xvli5t r-zso239 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
                                >
                                    <g>
