                    ...
                    >
                        <img
                            ...
                            style={{
                                ...
                                borderRadius: "50%",
                                boxShadow:
                                    "rgba(0, 0, 0, 0.02) 0px 0px 2px inset",
                            }}
                            src={avatar}
                            alt="avatar"
                        />
                    ...
                    <div>
                        <p>
                            <span className="mx-1">
                                <button
                                    type="button"
                                    style={{ color: likeColor.color }}
                                    className="backarrow btn btn-sm like"
                                    onClick={(e) => {
                                        addLike(_id);
                                        onChange(e);
                                    }}
                            ...
                            <span className="mx-1">
                                <Link
                                    to={`/tweets/${_id}`}
                                    type="button"
                                    className="backarrow btn btn-sm comment"
                                >
                                    <span>
                                        <svg
                                            viewBox="0 0 24 24"
                            ...
                            {!auth.loading && user === auth.user._id && (
                                <button
                                    type="button"
                                    onClick={(e) => deleteTweet(_id)}
                                    className="backarrow btn btn-sm mx-1"
                                    style={{ color: "#d9534f" }}
                                >
                                    <svg
                                        viewBox="0 0 24 24"
                                        class="r-daml9f r-4qtqp9 r-yyyyoo r-1q142lx r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
                                    >
                                        <g>
