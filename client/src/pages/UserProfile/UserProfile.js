            ...
            <Fragment>
                <div className="container">
                    ...
                    <div className="r-1ye8kvj css-1dbjc4n r-yfoy6g r-18bvks7 r-1ljd8xs r-13l2t4g r-1phboty r-1jgb5lz r-11wrixw r-61z16t r-1ye8kvj r-13qz1uu r-184en5c mx-0">
                        ...
                        <p className="mb-2">
                            <div className='mb-0' ><span style={{ fontWeight: '800', fontSize: '19px' }}>{ profile.user && profile.user.name }</span><Link to='/editprofile'><button className='ml-2 followbutton'>Edit Profile</button></Link></div>
